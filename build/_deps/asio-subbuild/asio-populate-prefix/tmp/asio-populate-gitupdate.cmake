...
execute_process(
  COMMAND "/usr/bin/git" --git-dir=.git show-ref "asio-1-28-0"
  WORKING_DIRECTORY "/home/senjoe/Documents/p2pblockchain/build/_deps/asio-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/senjoe/Documents/p2pblockchain/build/_deps/asio-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/senjoe/Documents/p2pblockchain/build/_deps/asio-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
